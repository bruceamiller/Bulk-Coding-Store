...
//if you can't divide a third number by the gcd of the first two, can you linear combine the first two to get the third number?
//So we can already rule out numbers for either side of the prize pair, if you can't divide it by the gcd of the buttons before...
//And then I can find a linear combination, but is it the best one?
//Maybe there's some way to start with negative combinations, and go out of that??
//Or some way that linear combinations will overlap between both X and Y??
